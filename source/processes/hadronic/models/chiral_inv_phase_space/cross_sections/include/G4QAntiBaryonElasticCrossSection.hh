...
//
//
// GEANT4 physics class: G4QAntiBaryonElasticCrossSection -- header file
...
#ifndef G4QAntiBaryonElasticCrossSection_h
#define G4QAntiBaryonElasticCrossSection_h 1
...
class G4QAntiBaryonElasticCrossSection : public G4VQCrossSection
{
protected:

  G4QAntiBaryonElasticCrossSection();               // Constructor
