...
//
//
// GEANT4 physics class: G4QHyperonElasticCrossSection -- header file
...
#ifndef G4QHyperonElasticCrossSection_h
#define G4QHyperonElasticCrossSection_h 1
...
class G4QHyperonElasticCrossSection : public G4VQCrossSection
{
protected:

  G4QHyperonElasticCrossSection();               // Constructor
