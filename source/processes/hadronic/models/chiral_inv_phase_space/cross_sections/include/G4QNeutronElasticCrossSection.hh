...
//
//
// GEANT4 physics class: G4QNeutronElasticCrossSection -- header file
...
#ifndef G4QNeutronElasticCrossSection_h
#define G4QNeutronElasticCrossSection_h 1
...
class G4QNeutronElasticCrossSection : public G4VQCrossSection
{
protected:

  G4QNeutronElasticCrossSection();               // Constructor
