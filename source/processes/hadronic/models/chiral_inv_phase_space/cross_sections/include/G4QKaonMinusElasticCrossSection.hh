...
//
//
// GEANT4 physics class: G4QKaonMinusElasticCrossSection -- header file
...
#ifndef G4QKaonMinusElasticCrossSection_h
#define G4QKaonMinusElasticCrossSection_h 1
...
class G4QKaonMinusElasticCrossSection : public G4VQCrossSection
{
protected:

  G4QKaonMinusElasticCrossSection();               // Constructor
