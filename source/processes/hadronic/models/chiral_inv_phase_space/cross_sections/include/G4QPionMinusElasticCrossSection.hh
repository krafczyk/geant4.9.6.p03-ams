...
//
//
// GEANT4 physics class: G4QPionMinusElasticCrossSection -- header file
...
#ifndef G4QPionMinusElasticCrossSection_h
#define G4QPionMinusElasticCrossSection_h 1
...
class G4QPionMinusElasticCrossSection : public G4VQCrossSection
{
protected:

  G4QPionMinusElasticCrossSection();               // Constructor
